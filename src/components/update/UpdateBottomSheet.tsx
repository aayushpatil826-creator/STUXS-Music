...
export const UpdateBottomSheet: React.FC<UpdateBottomSheetProps> = ({
  ...
  return (
    ...
    >
      <div className="w-full max-w-md bg-[#FAF8F5] dark:bg-[#16161E] rounded-t-[32px] sm:rounded-3xl border border-stuxs-border shadow-2xl overflow-hidden flex flex-col max-h-[85vh] animate-in slide-in-from-bottom duration-300">
        ...
        {/* Body Content */}
        <div className="px-5 py-2 overflow-y-auto space-y-4 flex-1">
          {/* Release Notes */}
        ...
        {/* Footer Actions */}
        <div className="p-5 pt-3 border-t border-stuxs-border/60 bg-[#FAF8F5]/80 dark:bg-[#16161E]/80 backdrop-blur-md">
